...
class UrbanRoutesPage:
    ...
    def is_phone_number_selected(self):
        return self.driver.find_element(*self.PHONE_INPUT).is_displayed()

    def is_credit_card_selected(self):
        return self.driver.find_element(*self.CARD_INPUT).is_displayed()

    def is_blanket_and_handkerchiefs_selected(self):
        return self.driver.find_element(*self.SWITCH_INPUT).get_property("checked")
